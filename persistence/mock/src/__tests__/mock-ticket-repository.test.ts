...
import { MockTicketRepository } from "../ticket/mock-ticket.repository";
import { Ticket } from "@servicar/core";
...
describe("integración con CambiarEstadoUseCase", async () => {
  it("el use case actualiza el ticket en el store vía el repo", async () => {
    const { CambiarEstadoUseCase } = await import("@servicar/core");
