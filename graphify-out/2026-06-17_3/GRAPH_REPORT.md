...
## Corpus Check
- 166 files · ~46,703 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 771 nodes · 1645 edges · 50 communities (42 shown, 8 thin omitted)
...
Cohesion: 0.06
Nodes (30): ESTADO_ACTIONS, TicketsView(), TicketsVM, useTicketsViewModel(), TicketEstado, CambiarEstadoDTO, CrearTicketDTO, EditarTicketDTO (+22 more)

### Community 1 - "Casos de Uso y Reglas de Negocio de Tickets"
Cohesion: 0.25
Nodes (8): ESTADO_CFG, EstadoChip(), FabButton(), FabButtonProps, TicketCard(), TicketCardProps, ViewHeader(), ViewHeaderProps

### Community 2 - "Configuración de Compilación TypeScript (Next.js)"
Cohesion: 0.08
Nodes (18): provider, store, MOCK_EMPLEADOS, MOCK_HISTORIAL, MOCK_TICKETS, MockDraft, MockHistorial, MockTicket (+10 more)

### Community 3 - "Dominio de Empleados y Control de Acceso"
Cohesion: 0.07
Nodes (15): Empleado, mockEmpleadoToEntity(), MockEmpleadoRepository, PbUser, pbUserToEmpleado(), PbEmpleadoRepository, Listener, PbStore (+7 more)
...
Cohesion: 0.16
Nodes (11): AdminLayoutView(), AdminLayoutViewProps, NAV, AdminLayout(), AdminLayoutVM, useAdminLayoutViewModel(), DashboardPage(), useStoreReactive() (+3 more)

### Community 7 - "Gestión de Dependencias (package.json)"
Cohesion: 0.09
Nodes (14): HistorialEntry, HistorialEntryProps, TipoAccion, TicketProps, MockHistorialRepository, mockHistorialToEntity(), PbHistorialRepository, entityToPbHistorialData() (+6 more)
...
Cohesion: 0.26
Nodes (6): ColaView(), Action, ColaVM, PendingAction, useColaViewModel(), ColaPage()
...
Cohesion: 0.09
Nodes (16): provider, useCase, AggregateRoot, Rol, isTransicionValida(), TICKET_ESTADO_TRANSITIONS, AutenticarDTO, EmpleadoProps (+8 more)
...
Cohesion: 0.24
Nodes (4): entityToMockHistorial(), entityToMockTicket(), mockTicketToEntity(), MockTicketRepository
...
Cohesion: 0.19
Nodes (8): ESTADO_CFG, HistorialView(), HistorialTab, HistorialVM, useHistorialViewModel(), HistorialPage(), authModule, getPocketBase()

### Community 42 - "Community 42"
Cohesion: 0.14
Nodes (18): TicketCategoria, WORKSHOP_CATEGORIAS, EditarTicketPage(), NuevoTicketPage(), AlertBanner(), AlertBannerProps, AlertType, TYPE_CFG (+10 more)
...
Cohesion: 0.28
Nodes (7): empleadoModule, TallerView(), FilterEstado, FILTROS, TallerVM, useTallerViewModel(), TallerPage()
...
## Knowledge Gaps
- **193 isolated node(s):** `name`, `private`, `workspaces`, `$schema`, `enabled` (+188 more)
...
- **Why does `Ticket` connect `Entidad de Dominio y Modelo de Ticket` to `Interfaz y Formularios de Tickets`, `Casos de Uso y Reglas de Negocio de Tickets`, `Community 37`, `Capa de Persistencia Simulada (Mock)`, `Gestión de Dependencias (package.json)`, `Community 40`, `Community 42`, `Community 43`, `Capa de Acceso a Datos de PocketBase`, `Community 45`, `Community 47`, `Panel de Administración y Control de Cola`, `Glosario y Reglas de Negocio (CLAUDE.md/README.md)`, `Pruebas Unitarias de la Entidad Ticket`, `Arquitectura de Despliegue y Orquestación Docker`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Empleado` connect `Dominio de Empleados y Control de Acceso` to `Interfaz y Formularios de Tickets`, `Capa de Persistencia Simulada (Mock)`, `Community 40`, `Reglas de Calidad y Estilo de Código (Biome)`, `Community 42`, `Community 43`, `Community 44`, `Capa de Acceso a Datos de PocketBase`, `Community 45`, `Panel de Administración y Control de Cola`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `PbStore` connect `Dominio de Empleados y Control de Acceso` to `Interfaz y Formularios de Tickets`, `Gestión de Dependencias (package.json)`, `Community 40`, `Estructura y Maquetación Principal (Layout)`, `Arquitectura de Despliegue y Orquestación Docker`?**
